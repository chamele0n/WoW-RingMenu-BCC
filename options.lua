...
function RingMenuOptions_SetupPanel()
    ...
    local function colorOnClick(self)
        ...
        RingMenu.OpenColorPicker(color, function(value)
            -- Color preview
    ...
    local version = RingMenu.GetAddOnMetadata("Version")

    -- Interface AddOns List Title
    panel.name = "RingMenu TBC Anniversary"

    -- Interface AddOn Panel Title
    local titleLabel = _G["RingMenuOptionsPanelTitle"]
    titleLabel:SetText("RingMenu TBC Anniversary |cFF888888v" .. (version or "unknown"))
    ...
    -- panel.cancel
    -- panel.default
    RingMenu.RegisterOptionsPanel(panel)
end
